...
import { Button, Form, Row, Col, Divider, Icon, Tooltip, Skeleton } from 'antd';
      ...
      <Skeleton loading={isEditDataLoading}>
        <Form className="form" onSubmit={matchFormik.handleSubmit}>
          <Row gutter={16} className="form-container">
            ...
            <Col span={8}>
              {matchFormik.values.matchTypeId == matchTypeConst.tournament ? (
                <CustomInput
                  title="Event"
                  type="text"
                  disabled={true}
            ...
            <Col span={8}>
              {matchFormik.values.matchTypeId == matchTypeConst.tournament && matchFormik.values.eventId ? (
                <CustomInput
                  title="Event Stage"
                  type="select"
                  disabled={true}
