...
module.exports = {
  ...
  data: appLocaleData,
  messages: {
    'app.home.introduce': 'Score Exec is cricket management webApp portal where we market local clubs and cricket teams to maintain their records and statistics',
    'app.home.design-language': 'Achievements',
